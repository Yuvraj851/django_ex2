...
class EmployeeEducation(models.Model):
    ...
    yearofpassingpg = models.CharField(max_length=50,null=True)
    ...
    yearofpassinggra = models.CharField(max_length=50, null=True)
    ...
    coursepghsc = models.CharField(max_length=100, null=True)
